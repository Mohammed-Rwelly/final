...
def get_jobs(keyword, num_jobs, verbose, slp_time):
    ...
    for i in range(3):
       # print("Progress: {}".format("" + str(len(jobs)) + "/" + str(num_jobs)))
        ...
        print(job_buttons1[i].get_attribute("href"))
        time.sleep(10)
        ...
        try:
            ...
            print(' x out failed')
        try:
            Posted_Date=driver.find_element(By.XPATH,'//*[@id="MainCol"]/div[1]/ul/li[{}]/div[2]/div[3]/div[2]/div[2]'.format(i+1)).text
        except NoSuchElementException:
            Posted_Date=driver.find_element(By.XPATH,'//*[@id="MainCol"]/div[1]/ul/li[{}]/div[2]/div[2]/div/div[2]'.format(i+1)).text
            pass
            
        job.append({"job_id":Posted_Date})
    return pd.DataFrame(job)                 

df=get_jobs('data', 2, False, 10)
